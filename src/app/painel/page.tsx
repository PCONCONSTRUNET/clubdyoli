  ...
  return (
    <>
      ...
      <main className="max-w-2xl mx-auto px-6 pt-12">
        ...
        {/* Banner Hero */}
        <div className="relative w-full rounded-[32px] overflow-hidden bg-gradient-to-br from-[#ffd9e8] to-[#f6d6e2] shadow-[0_15px_40px_rgba(255,105,180,0.15)] mb-10 p-8 border border-white/40">
          ...
          <div className="relative z-10 w-[70%]">
            ...
            <h2 className="text-xl sm:text-2xl font-black text-gray-800 leading-tight mb-4">
              Aproveite todas as vantagens do clube
            </h2>
            <button className="bg-[#ff4081] text-white px-5 sm:px-6 py-2 sm:py-3 rounded-full font-bold shadow-lg shadow-pink-500/30 hover:-translate-y-1 hover:bg-[#e91e63] transition-all duration-300 text-sm sm:text-base">
              Ver benefícios
            </button>
          </div>
